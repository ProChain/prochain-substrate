...
decl_storage! {
    trait Store for Module<T: Trait> as AdsModule {
        ...
        AdsRecords get(fn ads_records): map hasher(twox_64_concat) T::Hash => AdsMetadata<T::Balance, T::Moment>;
...
decl_module! {
	pub struct Module<T: Trait> for enum Call where origin: T::Origin {
        ...
        fn publish(origin, name: Vec<u8>, topic: Vec<u8>, total_amount: T::Balance, single_click_fee: T::Balance, period: T::Moment) {
            ...
            ensure!(total_amount >= Self::min_deposit(), "min deposit 500 prm");
        ...
        fn deposit(origin, value: T::Balance, memo: Vec<u8>) {
            ...
            ensure!(value >= Self::min_deposit(), "min deposit 100 prm");

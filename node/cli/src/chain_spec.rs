...
fn staging_testnet_config_genesis() -> GenesisConfig {
	// stash, controller, pallet_session-key
	// generated with secret:
	// for i in 1 2 3 4 ; do for j in stash controller; do subkey inspect "$secret"/fir/$j/$i; done; done
	// and
	// for i in 1 2 3 4 ; do for j in pallet_session; do subkey --ed25519 inspect "$secret"//fir//$j//$i; done; done
...
fn prochain_testnet_genesis() -> GenesisConfig {
	...
	let endowed_amount: Balance = 70_000_000 * DOLLARS - intial_total - total_stash;

...
use prochain_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	prochain_runtime::api::dispatch,
	prochain_runtime::native_version
);
...
macro_rules! new_full_start {
    ($config:expr) => {{
        ...
        let builder = substrate_service::ServiceBuilder::new_full::<
            prochain_runtime::opaque::Block,
            prochain_runtime::RuntimeApi,
        ...
        .with_import_queue(|_config, client, mut select_chain, transaction_pool| {
            ...
            let (block_import, link_half) =
                grandpa::block_import::<_, _, _, prochain_runtime::RuntimeApi, _, _>(
                    client.clone(),
                    client.clone(),
                    select_chain,
                )?;
